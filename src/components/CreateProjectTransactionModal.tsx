...
export default function CreateProjectTransactionModal({
  visible,
  onClose,
  project,
}: Props) {
  ...
  const projectColor = project.color || theme.primary || "#0D9488";
  ...
  return (
    <Modal
      key={`create-transaction-modal-${project.id || "new"}`}
      visible={visible}
      animationType="slide"
      transparent
              ...
              render={({ field: { onChange, value } }) => (
                ...
                >
                  <Ionicons
                    ...
                    size={20}
                    color={projectColor || theme.primary}
                  />
                  <TextInput
