...
export const projectService = {
  ...
  archiveProject: async (
    ...
    const response = await api.post(
      `/account/${accountId}/project/${projectId}/archive`,
    );
    return response.data;
  },
  ...
  getProjectTransactionById: async (
    accountId: string,
    projectId: string,
  ...
  createProjectTransaction: async (
    accountId: string,
    projectId: string,
    transactionData: CreateProjectTransactionDto,
  ): Promise<ProjectTransaction> => {
    const response = await api.post(
      `/account/${accountId}/project/${projectId}/transaction`,
      transactionData,
  ...
  updateProjectTransaction: async (
    accountId: string,
    projectId: string,
    transactionId: string,
    transactionData: UpdateProjectTransactionDto,
  ): Promise<ProjectTransaction> => {
    const response = await api.put(
      `/account/${accountId}/project/${projectId}/transaction/${transactionId}`,
      transactionData,
  ...
  deleteProjectTransaction: async (
    accountId: string,
    projectId: string,
    transactionId: string,
  ): Promise<void> => {
  ...
  downloadSummaryPDF: async (
    ...
    const currency = useCurrencyStore.getState().currency;
    const response = await api.get(
      `/account/${accountId}/project/${projectId}/pdf/summary?currency=${currency}`,
      {
        responseType: "arraybuffer",
      },
    );
