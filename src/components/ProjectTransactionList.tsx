...
export default function ProjectTransactionList({ project }: Props) {
  const { data, isLoading, error, deleteTransaction } = useProjectTransactions(
    project.id,
  );
  ...
  const [transactionToDelete, setTransactionToDelete] =
    useState<ProjectTransaction | null>(null);
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryItem}>
              ...
              <Text style={[styles.summaryValue, { color: theme.success }]}>
                {totals.real.toLocaleString()} {currency}
              </Text>
            </View>
          </View>
        </View>
                ...
                <View style={styles.badgesContainer}>
                  ...
                  {hasRealCost && (
                    ...
                    >
                      ...
                      >
                        {Math.abs(costDiff).toLocaleString()} {currency}
                      </Text>
                    </View>
                  )}
                  ...
                  >
                    ...
                    />
                    <Text
                      style={[styles.costBadgeText, { color: projectColor }]}
                    >
                      Est: {item.estimatedCost.toLocaleString()} {currency}
                    </Text>
                  </View>
                  {/* Bottom: Real Cost */}
                  {hasRealCost && (
                    ...
                    >
                      ...
                      />
                      <Text
                        style={[styles.costBadgeText, { color: theme.success }]}
                      >
                        {item.realCost?.toLocaleString()} {currency}
                      </Text>
                    </View>
                  )}
                </View>
