      ...
      >
            ...
            >
              <Ionicons
                name={
                  isCompleted
                    ? "checkmark-circle"
                    : (goal.iconRef as any) || "flag-outline"
                }
                size={20}
                color={displayColor}
              />
        ...
        <View style={styles.amountRow}>
          <View style={styles.amountInfo}>
            ...
            <Text style={[styles.amount, { color: displayColor }]}>
              {goal.amount.toLocaleString()} {currency}
            </Text>
          </View>
          <View
            style={[
          ...
          >
            ...
            <Text
              style={[styles.walletName, { color: displayColor }]}
              numberOfLines={1}
            >
              {walletName}
            </Text>
        ...
        <View style={styles.progressSection}>
          ...
          <View style={styles.progressInfo}>
            <Text
              style={[styles.currentAmount, { color: theme.textSecondary }]}
            >
              {isCompleted
                ? `${(goal.currentAmount || 0).toLocaleString()} ${currency} atteint`
                : `${(goal.currentAmount || 0).toLocaleString()} ${currency} épargnes`}
            </Text>
        ...
        {isCompleted && (
          <View
            style={[styles.expiredBadge, { backgroundColor: "#4CAF50" + "15" }]}
          >
            <Text style={[styles.expiredText, { color: "#4CAF50" }]}>
              Terminé
            </Text>
          </View>
        )}
