...
export default function CreateTransactionModal({ visible, onClose }: Props) {
  ...
  const [walletIdForGoals, setWalletIdForGoals] = useState<
    string | undefined
  >();
  const { goals: walletGoals, isLoading: isLoadingGoals } = useGoals({
    walletId: walletIdForGoals,
    status: "in_progress",
  });
      ...
      >
        {goalOptions.map((g) => (
          ...
          >
            ...
            <Text
              style={{
                color: selectedGoalId === g.id ? "#fff" : theme.text,
                marginLeft: 6,
              }}
            >
              {g.name}
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        selectedType === "OUT" ? "#fff" : theme.textSecondary,
                    },
                  ]}
                >
                  Depense
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        selectedType === "IN" ? "#fff" : theme.textSecondary,
                    },
                  ]}
                >
                  Revenu
